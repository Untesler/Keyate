...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/dashboard_elements_contents.css">
        ...
        <div class="content">
            <div class="text-component text--center">
                <nav class="nav nav-pills nav-fill navbar navbar-expand-lg navbar-light bg-light">
                    ...
                    <a class="nav-item nav-link btn" href="#">Bookmarks</a>
                </nav>

                <!-- put code structure -->
                <div class="gallery_bookmark" id="gallery_bookmark">
                    <div class="header">
                        <h1>Your bookmark</h1>
                    ...
                    <?php
                                 $results = null;
                                 [$info, $make_call] = call("GET", $GLOBALS['host']."/search/bookmarks", false, $GLOBALS["token"], false);
                                 if(in_array($info["http_code"], $GLOBALS['success_code'])){
                                     $response = json_decode($make_call, true);
