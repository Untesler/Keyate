        ...
        <div class="content">
            <div class="text-component text--center">
                <nav class="nav nav-pills nav-fill navbar navbar-expand-lg navbar-light bg-light">
                    <a class="nav-item nav-link btn" href="#">Gallery</a>
                ...
                <!-- put code structure -->
                <!-- popular work and work -->
                <div class="dashboard_element_wark_gallery">
                    <div class="row_popular_work">
                        <div style="margin-top:30px;">
                            <h1 style="margin-left: 60px;">Popular Work</h1>
                            <hr style="width: 90%; height: 2px; background-color: black; text-align: center;margin-bottom: 30px;">
                        </div>
                        <div class="row" style="margin-left: 30px;">
                            <?php
                                 $results = null;
                                 [$info, $make_call] = call("GET", $GLOBALS['host']."/search/popular/4", false, false, false);
                                 if(in_array($info["http_code"], $GLOBALS['success_code'])){
                                     $response = json_decode($make_call, true);
                                 ...
                                 if($results != "Not found"){
                                     foreach($results as $result){
                                        ...
                                        <div id="show_all_dashboard_elements" class="" style="  background-color: f4f4f4;padding-bottom: 0px;">
                                            <div id="dashboard_elements_gallery" class="boxWithPadding" style="  display: inline-table;
                                                    margin-bottom: 24px;
                                                    margin-right: 24px;
                                                ...
                                                <div class="box">
                                                    ...
                                                    <div class="cover" style="   vertical-align: top;width: 100%;">
                                                        <a href="'.$result["uid"].'" class="imageLink" style="word-break: break-all;" target="_blank">
                                                            <img src="'.$GLOBALS["host"].'/'.$result["path"].'" alt="" class="cover-imageIcon" style="width: 100%;height: 100%;max-width: 200px;max-height: 200px;display: block;margin: auto;">
                                                        </a>
                                                    </div>
                                                    <!-- detail -->
                                                    <div style="padding-top: 5px; padding-left: 10px;">
                                                        ...
                                                        <div style="margin-bottom: 2px;">
                                                            <a href="show.php?uid='.$result["uid"].'" style="word-break: break-all;   font-size: 3vw;" target="_blank">'.$result["name"].'</a>
                                                        </div>
                                                        <!-- book writer -->
                                                        <div class="txt" style="margin-bottom: 2px;">
                                                            <i alt="writer" class="fas fa-pen" style="color: #7a7a7a;" title="writer"></i>
                                                            <span style="word-break: break-all; ">
                                                        <a  href="profile.php?uid='.$result["illustratorId"].'" target="_blank" style="font-size: 1.5vw;">
                                                            '.$result["illustratorPenname"].'
                                                        </a>
                                                    </span>
                                                        </div>
                                                        <!-- book category -->
                                                        <div style="margin-bottom: 10px; word-wrap:  break-word; overflow: hidden; word-break: break-all; text-align: center;">
                                                            <p class="showInlineBlock height1Line view" style="font-size: 1vw;">
                                                                <span>
                    ...
                    <div class="row_works">
                        <div style="margin-top:30px;">
                            <h1 style="margin-left: 60px;">Works</h1>
                            <hr style="width: 90%; height: 2px; background-color: black; text-align: center;margin-bottom: 30px;">
                        </div>
                        <?php
                                 $results = null;
                                 ...
                                 $newRow = 0;
                                 $newRowOpen = '<div class="row" style="margin-left: 30px;">';
                                 $newRowClose = '</div>';
                                 if($results != "Not found"){
                                     
                                     foreach($results as $result){
                                        if($newRow == 4) $newRow = 0;
                                        if($newRow == 0) echo $newRowOpen;
                                        echo '
                                        <div class="col col-6 col-sm-3">
                                        <div id="show_all_dashboard_elements" class="" style="  background-color: f4f4f4;padding-bottom: 0px;">
                                            <div id="dashboard_elements_gallery" class="boxWithPadding" style="  display: inline-table;
